...
router.get('/trending', (req, res) => {
    ...
    function dataDB(r, titles3, RatesObj) {
        ...
        if (context3.length > RatesObj.length - 1) {
            context3 = context3.splice(0, RatesObj.length - 1)
        }
        let myAvgs = []
        context3.forEach((e, i) => {
            myAvgs.push(context3[i]['avgs'])
        })
        console.log(myAvgs)
        ...
        renderTemplate(avgs, titles3, rgbs, RatesObj, rgb, obj)
    }
    function renderTemplate(avgs, titles3, rgbs, RatesObj, rgb, obj) {
